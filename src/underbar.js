(function() {
  ...
  _.filter = function(collection, test) {
    ...
    for(var i = 0; i < collection.length; i++)
    {
      if(test(collection[i], collection))
  ...
  _.uniq = function(array) {
    ...
    {
      if(_.indexOf(newCollection, array[i]) === -1)
  ...
  _.map = function(collection, iterator) {
    ...
    var newCollection = [];
     _.each(collection, function (val, key)
      {
          newCollection[key] = iterator(val);
      });
  ...
  _.every = function(collection, iterator) {
    ...
    fails = _.reduce(collection, function (accumulator, val)
      {
          accumulator += iterator(val) ? 0 : 1;
          return accumulator;
      }, fails);
